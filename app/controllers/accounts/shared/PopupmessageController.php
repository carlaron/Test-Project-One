...
class PopupmessageController extends BaseController {
	...
	public function index($params=array()){
		...
		$params['message_dialog'] = "Hello This is a POP-UP I cant seem to put punctuation in here without it breaking the JQ Dialog pop-up";
