<html>
	<head>
		...
		<!--Load base CSS file-->
		<link rel="stylesheet" type="text/css" href="/accounts/foo/css/style.css" media="screen" />
		...
		<link rel="stylesheet" type="text/css" href="/accounts/foo/css/jquery-ui-local-overrides.css" />
...
//				});
	...
	<body>
		...
		<div id="container">
			...
			<div id="header">
				<a id="logo" href="/foo">Foo Account Site<br /><span style="font-size: 18px;">This will be different for every client</span></a>
